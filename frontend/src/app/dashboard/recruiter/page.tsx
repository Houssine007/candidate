            ...
            <main className="lg:ml-64 p-6 md:p-12">
                ...
                <div className="space-y-10">
                    <div className="flex items-end justify-between">
                        ...
                        <button onClick={() => router.push("/dashboard/recruiter/jobs/create")} className="text-xs font-black uppercase tracking-[0.2em] text-primary border-b-2 border-primary/20 hover:border-primary transition-all">Nouveau Poste +</button>
                    </div>
